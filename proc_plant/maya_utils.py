...
from proc_plant.consts import MTL_NS, TMP_NS, SUBDIV_CATCLARK, SUBDIV_LINEAR
...
def set_arnold_displacement_attrs(obj_name, subdiv_type=SUBDIV_CATCLARK, ai_subdiv_iterations=3, should_auto_bump=True):
    ...
    :param subdiv_type: type of subdivision algorithm (SUBDIV_CATCLARK, SUBDIV_LINEAR)
